...
export async function GetOrAddUserModelByGoogle(googleId: string, email: string, googleCredentials?: Credentials): Promise<UserModel | void> {
...
async function getUserFromGoogleId(googleId: string): Promise<UserModel | void> {
...
export async function updateUser(user: UserModel): Promise<UserModel | void> {
